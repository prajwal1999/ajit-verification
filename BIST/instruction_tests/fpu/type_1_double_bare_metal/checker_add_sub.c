...
int checker_add_sub(int *results_section, int *data_coverage, int instr_opcode, int number_of_inputs) {
    ...
    for(i=0; i<number_of_inputs; i++) {
        ...
        // after this float type is either normal or subnormal
            ...
            // ee_printf("diff_exp1_exp2 - %d\n", diff_exp_inp);

            // if(i == 479) ee_printf("i. %d, rest_1 is - 0x%x %x\n",i+1, rest_1, rest_1);
            // ee_printf("rest_2 is - 0x%x %x\n", rest_2, rest_2);
            ...
            if(exp_res > exp_1) {
                ...
                // if(i == 479) ee_printf("i. %d, rest1_sign is %d\n", i+1, rest_sign);
                ...
                if(i == 180) ee_printf("i. %d, updated mantissa_1 is 0x%x %x\n",i+1, mantissa_1, mantissa_1);
                real_val_1 = ((uint64_t)(input_1_1 & 0x80000000)) << 32;
                if(i == 180) ee_printf("intrm real_1 is - 0x%x %x\n", real_val_1, real_val_1);
