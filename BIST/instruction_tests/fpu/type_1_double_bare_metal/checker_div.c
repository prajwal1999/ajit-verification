...
int checker_div(int *results_section, int *data_coverage, int instr_opcode, int number_of_inputs) {
    ...
    for(i=0; i<number_of_inputs; i++) {
        ...
        if(float_type_1 == 2 && float_type_2 == 2) {
            ...
            int t_result_1 = 0x7ff00000 | ((input_1_1^input_2_1) & 0x80000000);
            if(result_1 == t_result_1 && result_2 == 0) n_correct_tests++;
            else test_failed = 1;
        } 
        else if(float_type_2 == 3) { // infinity
            // expected result is zero
            int t_result_1 = 0x00000000 | ((input_1_1^input_2_1) & 0x80000000);
            if(result_1 == t_result_1 && result_2 == 0) n_correct_tests++;
            else test_failed = 1;
        }
