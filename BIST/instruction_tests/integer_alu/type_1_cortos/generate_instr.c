...
int generate_instr(int *test_program_ptr, int results_section_ptr, int *register_coverage_ptr, int register_seed, char instr_opcode, int *save_register_ptr, int number_of_inputs)
{   
