    ...
    */
    ...
    for(i=0; i<number_of_inputs; i++)
    {
        ...
        *store_instr_at = generate_f_opcode_10(rd, rs1, rs2, instr_opcode, 0b110100); store_instr_at++; 
        ...
        // store result
        *store_instr_at = generate_opcode_11(rd, result_sec_base_reg, 0, mem_op_codes[3], 1, 12); store_instr_at++; 

        // increment result_sec_base_reg = result_sec_base_reg + 32
        *store_instr_at = generate_opcode_10(result_sec_base_reg, result_sec_base_reg, 0, 0b000000, 1, 16); store_instr_at++;
    }
