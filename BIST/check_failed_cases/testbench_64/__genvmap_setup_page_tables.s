...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=7, level=2,  ppnr=0x401c0000, p_addr=0x1c, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x1c) = 0x401c08e (pte)
   set 0x401c08e, %g2
   set 0x1c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=8, level=2,  ppnr=0x40200000, p_addr=0x20, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x20) = 0x402008e (pte)
   set 0x402008e, %g2
   set 0x20, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
