...
$AJIT_FLASH_IMAGE_DIR/bin/mmapToAssyU64 main.mmap main_copy_asm.s $TEXTBASE 0x50000
...
compileToSparcUclibc.py -s $AJIT_FLASH_IMAGE_DIR/asm/bootstrap_u64.s -s main_copy_asm.s -N bootstrap  -L bootstrapLinkerScript.lnk
