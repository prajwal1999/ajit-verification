...
page_table_setup:
   ...
   !PTD: context=0, index=0, level=0, child_p_addr=0x0, p_addr=0x400
   ...
   st %g4, [%g3]
   ! g4 stored into [g3] 
   !PTE: context=0, index=0, level=1,  ppnr=0x0, p_addr=0x0, cacheable=0x1, acc=0x3
...
! start: set context-table-pointer = PAGE_TABLE_BASE + 0x400
